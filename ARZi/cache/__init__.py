...
def clear_config():
    from ARZi.utils import _get_config, get_app_config
...
def clear_standings():
    ...
    from ARZi.api.v1.scoreboard import ScoreboardDetail, ScoreboardList
    from ARZi.constants.static import CacheKeys
    from ARZi.models import Teams, Users  # noqa: I001
    from ARZi.utils.scoreboard import get_scoreboard_detail
    from ARZi.utils.scores import get_standings, get_team_standings, get_user_standings
...
def clear_challenges():
    from ARZi.utils.challenges import get_all_challenges  # noqa: I001
...
def clear_pages():
    from ARZi.utils.config.pages import get_page, get_pages
...
def clear_user_recent_ips(user_id):
    from ARZi.utils.user import get_user_recent_ips

    cache.delete_memoized(get_user_recent_ips, user_id=user_id)


def clear_user_session(user_id):
    from ARZi.utils.user import (  # noqa: I001
        get_user_attrs,
        get_user_place,
        get_user_recent_ips,
        get_user_score,
...
def clear_team_session(team_id):
    from ARZi.utils.user import get_team_attrs, get_team_place, get_team_score
