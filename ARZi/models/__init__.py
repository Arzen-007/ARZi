...
class Notifications(db.Model):
    ...
    @property
    def html(self):
        from ARZi.utils.config.pages import build_markdown
        from ARZi.utils.helpers import markup
...
class Pages(db.Model):
    ...
    @property
    def html(self):
        from ARZi.utils.config.pages import build_html, build_markdown
...
class Challenges(db.Model):
    ...
    def plugin_class(self):
        from ARZi.plugins.challenges import get_chal_class
...
class Users(db.Model):
    ...
    def validate_password(self, key, plaintext):
        from ARZi.utils.crypto import hash_password
    ...
    def get_place(self, admin=False, numeric=False):
        """
        This method is generally a clone of ARZi.scoreboard.get_standings.
        The point being that models.py must be self-reliant and have little
        to no imports within the ARZi application as importing from the
        application itself will result in a circular import.
        """
        from ARZi.utils.humanize.numbers import ordinalize
        from ARZi.utils.scores import get_user_standings
...
class Teams(db.Model):
    ...
    def get_invite_code(self):
        ...
        from ARZi.utils.security.signing import hmac, serialize
    ...
    def load_invite_code(cls, code):
        ...
        from ARZi.exceptions import TeamTokenExpiredException, TeamTokenInvalidException
    ...
    def get_place(self, admin=False, numeric=False):
        ...
        """
        from ARZi.utils.humanize.numbers import ordinalize
        from ARZi.utils.scores import get_team_standings  # noqa: I001
