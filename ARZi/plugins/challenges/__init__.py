...
from ARZi.plugins import register_plugin_assets_directory
from ARZi.plugins.flags import FlagException, get_flag_class
from ARZi.utils.uploads import delete_file
from ARZi.utils.user import get_ip
...
class ARZiStandardChallenge(BaseChallenge):
...
"""
Global dictionary used to hold all the Challenge Type classes used by ARZi. Insert into this dictionary to register
your Challenge Type.
"""
CHALLENGE_CLASSES = {"standard": ARZiStandardChallenge}
