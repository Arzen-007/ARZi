...
from ARZi.constants.config import (
...
from ARZi.constants.themes import DEFAULT_THEME
from ARZi.models import (
    Admins,
    Files,
    Notifications,
    Pages,
...
from ARZi.utils import config, get_config, set_config
from ARZi.utils import user as current_user
from ARZi.utils import validators
from ARZi.utils.config import is_setup, is_teams_mode
from ARZi.utils.config.pages import build_markdown, get_page
from ARZi.utils.config.visibility import challenges_visible
from ARZi.utils.dates import ctf_ended, ctftime, view_after_ctf
from ARZi.utils.decorators import authed_only
from ARZi.utils.email import (
...
from ARZi.utils.health import check_config, check_database
from ARZi.utils.helpers import get_errors, get_infos, markup
from ARZi.utils.modes import USERS_MODE
from ARZi.utils.security.auth import login_user
from ARZi.utils.security.csrf import generate_nonce
from ARZi.utils.security.signing import (
    BadSignature,
    BadTimeSignature,
    SignatureExpired,
    serialize,
...
from ARZi.utils.uploads import get_uploader, upload_file
from ARZi.utils.user import authed, get_current_team, get_current_user, get_ip, is_admin
...
def setup():
    ...
    <div class="col-md-6 offset-md-3">
        ...
        <h3 class="text-center">
            <p>A cool CTF platform from <a href="https://arzi.io">arzi.io</a></p>
            <p>Follow us on social media:</p>
            <a href="https://twitter.com/arziio"><i class="fab fa-twitter fa-2x" aria-hidden="true"></i></a>&nbsp;
            <a href="https://facebook.com/arziio"><i class="fab fa-facebook fa-2x" aria-hidden="true"></i></a>&nbsp;
            <a href="https://github.com/arzi"><i class="fab fa-github fa-2x" aria-hidden="true"></i></a>
        </h3>
        <br>
...
def themes_beta(theme, path):
    ...
    In ARZi 4.0 this url_for behavior and this themes_beta
