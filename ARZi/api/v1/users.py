...
from ARZi.cache import clear_challenges, clear_standings, clear_user_session
...
from ARZi.schemas.awards import AwardSchema
from ARZi.schemas.submissions import SubmissionSchema
from ARZi.schemas.users import UserSchema
from ARZi.utils.challenges import get_submissions_for_user_id_for_challenge_id
from ARZi.utils.config import get_config, get_mail_provider
from ARZi.utils.decorators import admins_only, authed_only, ratelimit
from ARZi.utils.decorators.visibility import (
    check_account_visibility,
    check_score_visibility,
)
from ARZi.utils.email import sendmail, user_created_notification
from ARZi.utils.helpers.models import build_model_filters
from ARZi.utils.security.auth import update_user
from ARZi.utils.user import get_current_user, get_current_user_type, is_admin
...
class UserPublic(Resource):
    ...
    def patch(self, user_id):
        ...
        # https://github.com/ARZi/ARZi/issues/1794
        response = schema.dump(response.data)
        db.session.commit()
        db.session.close()
...
class UserPrivateSubmissions(Resource):
    @authed_only
    def get(self):
        # TODO: ARZi 4.0 Self viewing submissions should not be enabled by default until further notice
