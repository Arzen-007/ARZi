...
from ARZi.constants.config import ChallengeVisibilityTypes, Configs
from ARZi.utils.config import is_teams_mode
from ARZi.utils.dates import ctf_ended, ctf_paused, ctf_started
...
from ARZi.utils.user import authed, get_current_team
