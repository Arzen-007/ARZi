...
from ARZi.models import Solves, Users
from ARZi.utils import get_config
from ARZi.utils.config import is_teams_mode
from ARZi.utils.formatters import safe_html_format
...
class SolveSocialShare(object):
    ...
    @property
    def content(self):
        from ARZi.utils.challenges import get_solve_counts_for_challenges
