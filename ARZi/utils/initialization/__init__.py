...
from ARZi.cache import clear_user_recent_ips
from ARZi.exceptions import UserNotFoundException, UserTokenExpiredException
from ARZi.models import Tracking, db
from ARZi.utils import config, get_app_config, get_config, import_in_progress, markdown
from ARZi.utils.config import (
    can_send_mail,
    ctf_logo,
    ctf_name,
    ctf_theme,
...
from ARZi.utils.config.pages import get_pages
from ARZi.utils.dates import isoformat, unix_time, unix_time_millis, unix_time_to_utc
from ARZi.utils.events import EventManager, RedisEventManager
from ARZi.utils.humanize.words import pluralize
from ARZi.utils.modes import generate_account_url, get_mode_as_word
from ARZi.utils.plugins import (
...
from ARZi.utils.security.auth import login_user, logout_user, lookup_user_token
from ARZi.utils.security.csrf import generate_nonce
from ARZi.utils.user import (
    authed,
...
def init_template_globals(app):
    from ARZi.constants import JINJA_ENUMS  # noqa: I001
    from ARZi.constants.assets import Assets
    from ARZi.constants.config import Configs
    from ARZi.constants.languages import Languages
    from ARZi.constants.plugins import Plugins
    from ARZi.constants.sessions import Session
    from ARZi.constants.static import Static
    from ARZi.constants.teams import Team
    from ARZi.constants.users import User
    from ARZi.forms import Forms
    from ARZi.utils.config.visibility import (
        accounts_visible,
        challenges_visible,
        registration_visible,
        scores_visible,
    )
    from ARZi.utils.countries import get_countries, lookup_country_code
    from ARZi.utils.countries.geoip import lookup_ip_address, lookup_ip_address_city
