...
from ARZi.utils.dates import ctf_ended, ctf_started, ctftime, view_after_ctf
from ARZi.utils.user import authed, get_current_team, get_current_user, is_admin
...
def require_complete_profile(f):
    from ARZi.utils.helpers import info_for
