...
from ARZi.cache import cache, clear_user_session
from ARZi.constants.languages import Languages
from ARZi.constants.teams import TeamAttrs
from ARZi.constants.users import UserAttrs
from ARZi.models import Fails, Teams, Tracking, Users, db
from ARZi.utils import get_config
from ARZi.utils.security.auth import logout_user
from ARZi.utils.security.signing import hmac
...
def get_ip(req=None):
    ...
    ARZi does not use IP address for anything besides cursory tracking of teams and it is ill-advised to do much
