...
function updateConfigs(event) {
  ...
  ARZi.api.patch_config_list({}, params).then(function (_response) {
...
function uploadLogo(event) {
  ...
  helpers.files.upload(form, {}, function (response) {
    ...
    ARZi.fetch("/api/v1/configs/ctf_logo", {
      method: "PATCH",
...
function switchUserMode(event) {
  ...
  if (confirm(msg)) {
    ...
    formData.append("nonce", ARZi.config.csrfNonce);
    fetch(ARZi.config.urlRoot + "/admin/reset", {
      method: "POST",
...
function smallIconUpload(event) {
  ...
  helpers.files.upload(form, {}, function (response) {
    ...
    ARZi.fetch("/api/v1/configs/ctf_small_icon", {
      method: "PATCH",
      body: JSON.stringify(params),
    })
      .then(function (response) {
...
function importCSV(event) {
  ...
  form_data.append("nonce", ARZi.config.csrfNonce);
  ...
  $.ajax({
    url: ARZi.config.urlRoot + "/admin/import/csv",
    type: "POST",
    data: form_data,
    processData: false,
    contentType: false,
...
function importConfig(event) {
  ...
  $.ajax({
    url: ARZi.config.urlRoot + "/admin/import",
    type: "POST",
    data: form_data,
    processData: false,
    contentType: false,
    ...
    success: function (_data) {
      ...
      location.href = ARZi.config.urlRoot + "/admin/import";
    },
  });
}
