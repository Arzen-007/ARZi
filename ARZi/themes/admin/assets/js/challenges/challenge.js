...
$(() => {
  $(".preview-challenge").click(function (_event) {
    ...
    $.get(
      ARZi.config.urlRoot + "/api/v1/challenges/" + window.CHALLENGE_ID,
      function (response) {
        const challenge_data = response.data;
        challenge_data["solves"] = null;

        $.getScript(
          ARZi.config.urlRoot + challenge_data.type_data.scripts.view,
          function () {
            $.get(
              ARZi.config.urlRoot + challenge_data.type_data.templates.view,
              function (template_data) {
                ...
                challenge_data["script_root"] = ARZi.config.urlRoot;
