...
Alpine.data("TeamGraphs", () => ({
  ...
  async init() {
    this.solves = await ARZi.pages.teams.teamSolves(window.TEAM.id);
    this.fails = await ARZi.pages.teams.teamFails(window.TEAM.id);
    this.awards = await ARZi.pages.teams.teamAwards(window.TEAM.id);
