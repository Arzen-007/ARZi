...
const updateScores = () => {
  ARZi.api.get_scoreboard_list().then(response => {
...
const buildGraphData = () => {
  return ARZi.api.get_scoreboard_detail({ count: 10 }).then(response => {
    ...
    const option = {
      title: {
        left: "center",
        text: "Top 10 " + (ARZi.config.userMode === "teams" ? "Teams" : "Users")
      },
      tooltip: {
        trigger: "axis",
        axisPointer: {
