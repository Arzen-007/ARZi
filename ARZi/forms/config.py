...
from ARZi.constants.languages import SELECT_LANGUAGE_LIST
from ARZi.forms import BaseForm
from ARZi.forms.fields import SubmitField
from ARZi.utils.csv import get_dumpable_tables
...
class LocalizationForm(BaseForm):
    default_locale = SelectField(
        "Default Language",
        description="Language to use if a user does not specify a language in their account settings. By default, ARZi will auto-detect the user's preferred language.",
