...
from ARZi import config, create_app
from ARZi.utils import string_types

# This is important to allow access to the ARZi application factory
...
if __name__ == "__main__":
    ...
    print(
        ...
        * creating a ARZi export
        * creating a dump of your actual database
        * and backing up the ARZi source code directory"""
    )
    ...
    for unlock in old_data["unlocks"]:
        unlock["user_id"] = unlock.pop(
            "teamid"
        )  # This is intentional as previous ARZis are effectively in user mode
