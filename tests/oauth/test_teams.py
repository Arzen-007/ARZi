...
from tests.helpers import create_arzi, destroy_arzi, gen_team, login_with_mlc
...
def test_team_size_limit():
    ...
    app.config.update(
        {
            "OAUTH_CLIENT_ID": "arzi_testing_client_id",
            "OAUTH_CLIENT_SECRET": "arzi_testing_client_secret",
