...
def test_update_check_identifies_update(fake_get_request):
    ...
    with app.app_context():
        ...
        fake_response.json = lambda: {
            "resource": {
                "download_url": "https://api.github.com/repos/ARZi/ARZi/zipball/9.9.9",
                "html_url": "https://github.com/ARZi/ARZi/releases/tag/9.9.9",
                "id": 12,
                "latest": True,
                "next": 1542212248,
                "prerelease": False,
        ...
        assert (
            ...
            == "https://github.com/ARZi/ARZi/releases/tag/9.9.9"
        )
...
def test_update_check_notifies_user():
    ...
    with app.app_context():
        app.config["UPDATE_CHECK"] = True
        set_config("version_latest", "https://github.com/ARZi/ARZi/releases/tag/9.9.9")
        ...
        assert "https://github.com/ARZi/ARZi/releases/tag/9.9.9" in response
...
def test_update_check_ignores_downgrades(fake_post_request):
    ...
    with app.app_context():
        ...
        fake_response.json = lambda: {
            "resource": {
                "html_url": "https://github.com/ARZi/ARZi/releases/tag/0.0.1",
                "download_url": "https://api.github.com/repos/ARZi/ARZi/zipball/0.0.1",
                "published_at": "Wed, 25 Oct 2017 19:39:42 -0000",
                "tag": "0.0.1",
                "prerelease": False,
                "id": 6,
        ...
        fake_response.json = lambda: {
            "resource": {
                "html_url": "https://github.com/ARZi/ARZi/releases/tag/{}".format(
                    app.VERSION
                ),
                "download_url": "https://api.github.com/repos/ARZi/ARZi/zipball/{}".format(
                    app.VERSION
                ),
                "published_at": "Wed, 25 Oct 2017 19:39:42 -0000",
