...
from ARZi.utils.validators import validate_country_code, validate_email
...
def test_validate_email():
    ...
    assert validate_email("user.io@arzi") is False
    assert validate_email("user\\@arzi") is False
