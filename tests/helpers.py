...
from ARZi.cache import cache, clear_challenges, clear_standings
...
class ARZiTestClient(FlaskClient):
    def open(self, *args, **kwargs):
        ...
        return super(ARZiTestClient, self).open(*args, **kwargs)
...
class ctftime:
    ...
    def init():
        """
        This context manager can be used to setup start and end dates for a test ARZi
        """
        try:
    ...
    def not_started():
        """
        This context manager sets the current time to before the start date of the test ARZi
        """
        try:
    ...
    def started():
        """
        This context manager sets the current time to the start date of the test ARZi
        """
        try:
    ...
    def ended():
        """
        This context manager sets the current time to after the end date of the test ARZi
        """
        try:
...
def create_arzi(
    ...
    app.test_client_class = ARZiTestClient
